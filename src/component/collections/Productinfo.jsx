  ...
  return (
    ...
    >
      ...
      <div className="mb-8 flex flex-wrap items-center gap-4">
        ...
        <button className="flex flex-1 items-center justify-center gap-2 rounded-full bg-[#C8A96A] px-8 py-3.5 font-medium text-black transition hover:-translate-y-0.5 hover:shadow-xl sm:flex-none">
          <ShoppingBag size={18} />
          Add to Basket
        </button>
      </div>
